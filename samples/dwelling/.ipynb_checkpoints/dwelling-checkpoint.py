...
def train(model):
    ...
    dataset_train.load_dwelling(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = DwellingDataset()
    dataset_val.load_dwelling(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect dwellings.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/dwelling/dataset/",
                        help='Directory of the Dwelling dataset')
